...
<!-- 		<section class="bk">
			...
			<div class="container-1">
		    	<div class="contact-us">
					<form action="https://formspree.io/f/xgeqeedd"method="POST">
					  <label for="Name">NAME <em>&#x2a;</em></label><input id="name" name="name" required="" type="text" /> 
					  <small class="text-muted mx-auto">Eg: Jackin Fu</small><br><br>
					  ...
					  <label for="Phone">PHONE <em>&#x2a;</em></label><input id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="" type="tel" />
					  <small class="text-muted mx-auto">Eg: 012-345-6789</small><br><br>
					  <label for="Subject">SUBJECT <em>&#x2a;</em></label><input id="subject" name="subject" required="" type="text" /><br>
					  <label for="Message">YOUR MESSAGE <em>&#x2a;</em></label><textarea id="message" name="message" required="" rows="4"></textarea><br>
					  <h3>
		...
		<div class="container-1">
	    	<div class="contact-us">
				<form action="cu_nm.php"method="POST">
                    <div class="card-details">
                        <div class="card-box">
                            <span class="details">NAME<em>&#x2a;</em></span>
