            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="box-title">Pet Adopt Application Status </h4>
                           <br>
						    <?php if($_SESSION['ROLE']==2){ ?>
						   <h4 class="box_title_link"><a href="add_leave.php">Add New Adopt Form</a> </h4>
						   <?php } ?>
                        </div>
                        <div class="card-body--">
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <?php
									   if($row['leave_status']==2){ ?>
									   <a href="../adopt_login/appointmentform.html">Make Appointment</a>
									   <?php } ?>
