...
if(isset($_POST['add_to_cart'])){
	...
	// $select_cart = mysqli_query($con, "SELECT * FROM `marketplace_cart` WHERE product_name = '$product_name'");

	$select_cart = mysqli_query($con, "SELECT product_name FROM marketplace_cart");
		            ...
		            <div class ="display-style-btns">
		            	<a href="cart.php" class="cart nav-item nav-link avtive">
			    			...
			    			<button type ="button">
			    				...
			    				<span id="cart_count" class="text-warning bg-dark" style="border-radius: 3rem; text-align: center; padding: 0 0.9rem 0rem 0.9rem"><?php echo $row_count; ?></span>
		            	...
		            	<form action="" method="post">
							<div class = "item">
							    ...
							    <div class = "item-detail">
		        					...
		        					<input type = "hidden" class = "product-detail" name= "product_detail" value="<?php echo $fetch_product['product_detail']; ?>">
		        					<!-- <input type=""> -->
