...
<body>
	...
	<section class="bk">
		<div class="wtbl">
			<h1 class="h1" color="black">View Feedback</h1>
		</div>
		<div class="container-1">
	    	<div class="contact-us">
				...
				<div class="card-details">
					<div class="card-box">
						<span class="details">Feedback Response</span>
						<div class="showfb-1">
			...
			<br><button onclick="window.location.href = 'profile.php';"> Return to Homepage </button>
		</div>	
		<br><br>
	</section>
