			...
			<div class="container-fluid">
			  ...
			  <div class="collapse navbar-collapse justify-content-between navbar-links" id="navbarSupportedContent">
			    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
			      ...
			      <li class="nav-item active">
			          <a class="nav-link" href="admintools/admindatabase.php">DBMS</a>
			      </li>
			      <li class="nav-item active">
...
<!-- 			      <li class="nav-item active">
			      ...
			      <li class="nav-item dropdown">
			        <a class="nav-link dropdown-toggle" href="services.html" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Others</a>
			        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			       	  <a class="dropdown-item" href="adminfeedback.php">Feedback Management</a>	
			       	  <a class="dropdown-item" href="eventmanagementsystem/admin/index.php?page=home">Events & Promotions</a>	
