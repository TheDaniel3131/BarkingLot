			...
			<div class="card-body">
				<form action="" id="manage-venue">
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Event/Promotion</label>
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Time Duration</label>
							<input type="number" class="form-control text-right" step="any" name="duration"  value="<?php echo isset($duration) ? $duration :0 ?>" required>
						</div>
					</div>
					<br><br>
					<div class="form-group">
						<div><label for="" class="control-label">Event/Promotion Image(s)</label></div>
						<br>
